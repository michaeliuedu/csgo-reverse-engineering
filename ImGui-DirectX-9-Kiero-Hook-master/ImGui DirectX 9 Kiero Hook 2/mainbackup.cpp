//ignore this file just a stable release before implementation for development 
#include "includes.h"
#include <windows.h>
#include <tchar.h>
#include <TlHelp32.h>
...
DWORD WINAPI MainThread(HMODULE hModule)
{
	...
	while (true) {
		...
		if (localPlayer == 0 && gotdata == false) {
			...
			//TODO RECOIL FIX FOR STARTUP MENU REASOIN IS BECAUSE WE NEED TO GET TEH FRICKING DATA FROM THE LOCAL PLAYER AND WE CAN MAKE BOOL FUNCTION 
