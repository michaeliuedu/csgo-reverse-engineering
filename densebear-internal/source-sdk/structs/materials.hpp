...
public:
	...
	//	typedef void(__thiscall* o_color_modulate)(i_material*, float, float, float);
	//	return utilities::call_virtual<o_color_modulate>(this, 28)(this, r, g, b);
	//}

	bool is_precached() {
		typedef bool(__thiscall* o_is_precached)(void*);
		return utilities::call_virtual<o_is_precached>(this, 70)(this);
	}
};
