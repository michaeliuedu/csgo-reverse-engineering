...
public:
	NETVAR("DT_BaseCombatWeapon", "m_flNextPrimaryAttack", next_primary_attack, float)
		...
		NETVAR("DT_BaseCombatWeapon", "m_iItemDefinitionIndex", item_definition_index, short)
...
public:
	NETVAR("DT_BasePlayer", "m_hViewModel[0]", view_model, int)
		...
		NETVAR("DT_CSPlayer", "m_fFlags", flags, int)
		NETVAR("DT_CSPlayer", "m_iDefaultFOV", default_fov, int)
	...
	player_t* GetObserverTarget()
	{
		return interfaces::Call<player_t*>(this, 294);
	}
